...
export default function AddAppointmentScreen() {
  ...
  const [timePart, setTimePart] = useState(new Date(Date.now() + 60 * 60 * 1000)); 
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.h1}>Agregar Cita</Text>
...
const styles = StyleSheet.create({
  ...
  saveText: { color: '#06210f', fontWeight: '800', fontSize: 16 },
});
